# B-17 — Microservices Split (теория)

> **Статус:** placeholder — наполняется по запросу.  
> **Практика:** [../backend-phase-17-microservices-split.md](../backend-phase-17-microservices-split.md)
...
\\\csharp
// TODO: примеры для Microservices Split
\\\
