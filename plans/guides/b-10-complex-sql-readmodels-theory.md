# B-10 — SQL Optimization II (теория)

> **Статус:** placeholder — наполняется по запросу.  
> **Практика:** [../backend-phase-10-complex-sql-readmodels.md](../backend-phase-10-complex-sql-readmodels.md)
...
\\\csharp
// TODO: примеры для SQL Optimization II
\\\
