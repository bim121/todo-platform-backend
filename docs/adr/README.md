...
| ID | Файл | Тема | Статус |
|----|------|------|--------|
| ADR-021 | [021-domain-events.md](./021-domain-events.md) | Domain Events vs Integration Events, UoW, dispatch | **Accepted** (B-04.1–3) |
| ADR-020 | `020-clean-architecture-cqrs.md` | Clean Architecture + CQRS | planned (B-00) |
| ADR-022 | `022-caching-strategy.md` | Redis cache-aside | planned (B-06) |
